...
#define STRING_CONFIG_H_AUTHOR "(Bernie Solomon, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Dbot Marlin2"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 46.76
  #define  DEFAULT_bedKi 2.16
  #define  DEFAULT_bedKd 352.56
